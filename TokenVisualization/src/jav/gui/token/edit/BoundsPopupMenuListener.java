...
/**
 *
 * @author http://tips4java.wordpress.com/2010/11/28/combo-box-popup/
 */
 ...
 */
public abstract class BoundsPopupMenuListener implements PopupMenuListener
{
	...
	{
		Point parent = ((JComboBox) popup.getAccessibleContext().getAccessibleParent()).getLocationOnScreen();
